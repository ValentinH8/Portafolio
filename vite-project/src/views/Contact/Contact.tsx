...
const Contact = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (form.current) {
            emailjs.sendForm('service_npmmc3e', 'template_gwvy2he', form.current, 'aWZnXlJAxlj8Zs5k0')
                .then(() => {
                ...
                <form ref={form} className={styles.formularioMensaje} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.grupoInput}>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="Consulta, colaboración, etc."
                        />
                    </div>
                    <div className={styles.grupoInput}>
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            rows={4}
                            placeholder="Cuéntame sobre tu proyecto, requisitos, plazos y presupuesto..."
                            required
                        ></textarea>
                    </div>
